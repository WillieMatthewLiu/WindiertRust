...
**Current status (2026-04-08):** Partial. Command registration and smoke scripts pass, but the subcommands and host-validation flow are still placeholder-level.
